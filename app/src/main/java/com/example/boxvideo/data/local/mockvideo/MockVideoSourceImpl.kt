...
import com.example.boxvideo.data.local.mockvideo.model.MockVideoDto
import com.example.boxvideo.data.local.mockvideo.model.MockVideoQualityDto
import com.example.boxvideo.data.local.mockvideo.model.MockVideoSourceDto
import javax.inject.Inject

class MockVideoSourceImpl @Inject constructor() : VideoSource {
    override suspend fun getVideos(): List<MockVideoDto> {

        val videoFilesDto: List<MockVideoDto> = listOf(
            MockVideoDto(
                id = 1,
                title = "Leo",
            ...
            MockVideoDto(
                ...
                sources = listOf(
                    MockVideoSourceDto(
                        quality = _root_ide_package_.com.example.boxvideo.data.local.mockvideo.model.MockVideoQualityDto.P480,
                        url = "https://fayllar1.ru/35/kinolar/Yovvoyi%20robot%202024%20480p%20O'zbek%20tilida%20(asilmedia.net).mp4"
                    ),
                    MockVideoSourceDto(
                        quality = _root_ide_package_.com.example.boxvideo.data.local.mockvideo.model.MockVideoQualityDto.P720,
                        url = "https://fayllar1.ru/36/kinolar/Yovvoyi%20robot%202024%20720p%20O'zbek%20tilida%20(asilmedia.net).mp4"
                    ),
                    MockVideoSourceDto(
                        quality = _root_ide_package_.com.example.boxvideo.data.local.mockvideo.model.MockVideoQualityDto.P1080,
