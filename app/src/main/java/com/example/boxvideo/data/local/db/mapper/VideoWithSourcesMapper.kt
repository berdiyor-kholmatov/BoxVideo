package com.example.boxvideo.data.local.db.mapper

import com.example.boxvideo.data.local.db.VideoEntity
import com.example.boxvideo.data.local.db.VideoSourceEntity
import com.example.boxvideo.data.local.db.VideoWithSources
